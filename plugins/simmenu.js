 ...
 *Powered By @${'628961872896'.split('@')[0]}*` 
  let package = JSON.parse(await fs.promises.readFile(path.join(__dirname, '../package.json')).catch(_ => '{}'))
    ...
    const ultah = new Date('Januari 21, 2023 23:59:59')
...
const fkgif = {
	 ...
	 { remoteJid: "6289618728196@g.us" } : {}) 
                },
	 message: { 
		"extendedTextMessage": {
                 "text":`CUTE NR MD 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 "title": `CUTE NR MD 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
...
●────━───༺༻───━────●
                *《 BOT INFO 》*
⚘ *Bot Name: CUTE Nour Sean*
⚘ *Creator: Stah Ziv San*
⚘ *Contact Owner Bot*
*http://wa.me/6289618728196*
⚘ *Tanggal: ${date}*  
⚘ *Jam: ${time} WIB*
⚘ *Status: 「 ${mode} 」*
⚘ *Prefix: 「 MULTI PREFIX 」*
 ...
 *Official Bot By @${'0'.split('@')[0]}* 
 *Powered By @${'6289618728196'.split('@')[0]}*`
       let judul = `${ucapanl()}`.trim() 
       const sections = [
                              {
                                "rows": [{
                                         "title": "📊 › Status ",
                                         "description": "Status カ CUTE NR-MD",
                                         "rowId": ".botstat"
                                    }, {
                                         "title": "⚡› Speed ",
                                         "description": "Menampilkan Kecepatan Respon カ CUTE NR-MD",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› Info ",
                                         "description": "Menampilkan Info カ CUTE NR-MD",
                                         "rowId": ".info"
                                    }, {
                                         "title": "🎐 › Developer Bot ",
                  ...
                  "rowId": ".? owner"
                                ...
                                "description": "Last Update Terakhir Di CUTE NR-MD",
                                "rowId": ".notes"                  
                }],                
                                "title": "▮Last Update 」"
                                }, {
