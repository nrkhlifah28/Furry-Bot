		...
		message: {
			"productMessage": {
				"product": {
					...
					"description": `NOER BOTZ BY KHOLIFAH ❤️`, 
					"currencyCode": "Rp",
...
await conn.sendButtonImg(m.chat, await (await fetch(url)).buffer(), 'Kawai >_<', wm, 'NEXT', '.kanna', ftoko, {
    quoted: m, contextInfo:{externalAdReply: {title: 'Nih Kak Foto Kanna Nya', body: `${pickRandom(['Furry Indonesia :3', 'Suka Pokemon Nggak Kak :3', 'Kangen Aku Nggak?', 'Udah makan belum kak?', 'Udah Makan Belum?', 'Semangat ya kak!', 'Jangan begadang mulu ya!', 'Jangan spam ya kak!', 'Jangan lupa donasi yak kak! QωQ', 'Jaga kesehatan yaw kak!', 'Jangan lupa makan!', 'Jangan lupa istirahat yak! UωU', 'Haori Sayang Kamu :3', 'Pr nya udh belum kak?', 'Jangan kebanyakan main hp yk! nanti sakit :‹'])}`, sourceUrl: 'https://bit.ly/3N024o9', thumbnail: await (await fetch('https://telegra.ph/file/42eb819fd76aee00f08a8.jpg')).buffer(),}} 
    })
}
